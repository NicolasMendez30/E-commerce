...
import { addUser, removeUser } from "../redux/vinimakerSlice";
    ...
    <div className="w-full flex flex-col items-center justify-center gap-10 py-20">
      <div className="w-full flex items-center justify-center gap-10">
        ...
        >
          ...
          <span className="text-sm text-gray-900"> Regístrate con Google</span>
        </div>
        {userInfo && (
          <button
      ...
      {/*<div className="w-full flex items-center justify-center gap-10">
        ...
        >
          ...
          <span className="text-sm text-gray-900"> Regístrate con Github</span>
        </div>
        {userInfo && (
